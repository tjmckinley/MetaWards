# -*- coding: utf-8 -*-
#
# Metawards documentation build configuration file.
#
...
branch = os.getenv("METAWARDS_BRANCH", None)
...
if branch is None:
    ...
    revisionid = metawards.__revisionid__
    repository = metawards.__repository__
else:
    version = os.getenv("METAWARDS_VERSION")
    release = os.getenv("METAWARDS_RELEASE")
    revisionid = os.getenv("METAWARDS_REVISIONID")
    repository = os.getenv("METAWARDS_REPOSITORY")
...
# Replace all "|MetaWardsVersion|" with the version number
rst_epilog = f".. |MetaWardsVersion| replace:: {version}"
...
html_title = "MetaWards Documentation"

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = "MetaWards"
...
htmlhelp_basename = 'MetaWardsDoc'
...
latex_documents = [
    ('index', 'MetaWards.tex', u'MetaWards Documentation',
     u'Michel Lab', 'manual'),
]
