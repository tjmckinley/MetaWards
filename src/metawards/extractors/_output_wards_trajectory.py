...
__all__ = ["output_wards_trajectory"]


def output_wards_trajectory(population: Population,
    ...
    S_file = output_dir.open("wards_trajectory_S.dat")
    E_file = output_dir.open("wards_trajectory_E.dat")
    I_file = output_dir.open("wards_trajectory_I.dat")
    R_file = output_dir.open("wards_trajectory_R.dat")
